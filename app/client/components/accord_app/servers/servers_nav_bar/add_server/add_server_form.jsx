...
import { validUrlToken } from '@helpers';
    ...
    case 'create':
      return (
        <div className="image-upload-wrapper">
          ...
          {
            this.state.imageUrl ?
              <img src={ this.state.imageUrl } className="upload-img img"/> :
              null
          }
          <p
            onClick={this.fileOpen}
            onMouseOver={this.hovered}
            onMouseOut={this.notHovered}
            id="plus" className="plus"
          >
            <span>+</span>
            <i
              onClick={this.fileOpen}

        ...
        <nav className="servers-profile-nav">
          <ul className="nav-list">
            <li className="profile">
              <Link id="profile" onClick={this.classRemoveClick} className="profile-link" to="/channels/@me">
                <img src={globalThis.defaultAvatarUrl} alt="profile-img" className="profile-link" />
              </Link>
            </li>
